...
{
	[Activity (Label = "WCN.UIDroid", MainLauncher = true)]
	public class WebChangedNotificationListView : MvxActivity
	{
		protected override void OnCreate (Bundle bundle)
		{
			...
			SetContentView (Resource.Layout.WebChangedNotificationListView);
		}
	}
}
